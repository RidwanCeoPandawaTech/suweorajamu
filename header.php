...
<html>
<head>
	<title>Kedai Jamu Dan Kopi</title>
		...
		<div class="row top">
			<center>
				<div class="col-md-4" style="padding: 3px;">
					<span> <i class="glyphicon glyphicon-earphone"></i> 0877-2632-1972</span>
				</div>


				<div class="col-md-4"  style="padding: 3px;">
					<span><i class="glyphicon glyphicon-envelope"></i> ekiisnan@gmail.com</span>
				</div>


				<div class="col-md-4"  style="padding: 3px;">
					<span>Kedai Suwe Ora Jamu</span>
				</div>
			</center>
		</div>
	</div>
	...
	<nav class="navbar navbar-default" style="padding: 5px;">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#" style="color: #ff8680"><b>Suwe Ora Jamu</b></a>
			</div>
